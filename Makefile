...
OBJECTS_DIR=build
OUTFILE=kvadratka
OBJECT_FILES=main.o enter_print.o solve_square_equation.o utils.o tests.o
SOURCES=main.cpp enter_print.cpp solve_square_equation.cpp utils.cpp tests.cpp
